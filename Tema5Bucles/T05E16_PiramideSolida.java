...
class T05E16_PiramideSolida {
    public static void main(String[] args) {
        ...
        /*
        while (altura < 5) {
            System.out.println("Error: Debe ser mínimo de altura 5");
            System.out.print("Introduce de nuevo la altura: ");
